...
QT_MOC_LITERAL(1, 16, 24), // "DatabaseManagerServerLog"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 3) // "Log"

    },
    "DatabaseManager\0DatabaseManagerServerLog\0"
    "\0Log"
};
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->DatabaseManagerServerLog((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DatabaseManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DatabaseManager::DatabaseManagerServerLog)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DatabaseManager::DatabaseManagerServerLog(QString _t1)
{
