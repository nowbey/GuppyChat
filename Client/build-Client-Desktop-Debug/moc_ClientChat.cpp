...
QT_MOC_LITERAL(4, 49, 38), // "on_ListOfUsersWidget_itemDoub..."
QT_MOC_LITERAL(5, 88, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(6, 105, 4), // "item"
QT_MOC_LITERAL(7, 110, 19), // "SendMessageToServer"
QT_MOC_LITERAL(8, 130, 24), // "GuppyClientServerMessage"
QT_MOC_LITERAL(9, 155, 7), // "message"
QT_MOC_LITERAL(10, 163, 12), // "dataReceived"
QT_MOC_LITERAL(11, 176, 10) // "disconnect"

    },
    "ClientChat\0on_tabWidget_tabCloseRequested\0"
    "\0index\0on_ListOfUsersWidget_itemDoubleClicked\0"
    "QListWidgetItem*\0item\0SendMessageToServer\0"
...
void ClientChat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_ListOfUsersWidget_itemDoubleClicked((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->SendMessageToServer((*reinterpret_cast< const GuppyClientServerMessage(*)>(_a[1]))); break;
